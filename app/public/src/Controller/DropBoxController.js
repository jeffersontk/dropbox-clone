class DropBoxController{
    ...
    constructor(){
        ...
        //instancia do dom do html via ID
    ...
    connectFirebase(){
        ...
        // Initialize Firebase
        var config = {
                apiKey: "AIzaSyClXFDwJf6xKut1SVGiltPsRm5lTOvR5t8",
                authDomain: "dropbox-clone-fb1fe.firebaseapp.com",
                databaseURL: "https://dropbox-clone-fb1fe.firebaseio.com",
                projectId: "dropbox-clone-fb1fe",
                storageBucket: "dropbox-clone-fb1fe.appspot.com",
                messagingSenderId: "179290259479"
          };
    ...
    //metodo que fica na escuta do botão enviar 
    initEvents(){
        ...
        this.inputFilesEl.addEventListener('change', event =>{
            ...
            this.uploadtesk(event.target.files).then(responses =>{
